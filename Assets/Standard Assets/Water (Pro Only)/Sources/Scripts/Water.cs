...
public class Water : MonoBehaviour
{
    ...
    {
        /// <summary> the simple water state </summary>
        Simple = 0,

        /// <summary> the reflective water state </summary>
        Reflective = 1,

        /// <summary> the refractive water state </summary>
        Refractive = 2,
    };
    ...
    // This is called when it's known that the object will be rendered by some camera. We render reflections / refractions and do other updates here.
    // Because the script executes in edit mode, reflections for the scene view camera will just work!
    public void OnWillRenderObject()
    {
        ...
        // Actual water rendering mode depends on both the current setting AND the hardware support. There's no point in rendering refraction textures
    ...
    private void UpdateCameraModes(Camera src, Camera dest)
    {
        ...
        // update other values to match current camera. even if we are supplying custom camera&projection matrices, some of values are used elsewhere
        // (e.g. skybox uses far plane)
